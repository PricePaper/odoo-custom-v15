function initialize_map() {
    ...
    var partners = new google.maps.MarkerImage('/batch_delivery/static/src/img/map.png', new google.maps.Size(25, 25));
        ...
        if (!partner.latitude && !partner.longitude) {
            ...
            var bounds = new google.maps.LatLngBounds();
                ...
                google.maps.event.addListenerOnce(map, 'bounds_changed', function(event) {
                        if (this.getZoom() > 15) {
                           this.setZoom(9);
                           this.setCenter({lat:odoo_partner_data.partners[0].latitude,lng:odoo_partner_data.partners[0].longitude})
                    }
                    });
            var marker = new google.maps.Marker({
                partner: partner,
