...
class GenerateDiscountCheck(models.TransientModel):
    ...
    def get_invoices(self):
        ...
        if self.start_date and self.end_date:
            ...
            vendor_bills = self.env['account.move'].search([('move_type','=','in_invoice'), ('state', '=', 'open'), ('discount_due_date', '>', self.start_date), ('discount_due_date', '<', self.end_date)])

            vendor_bills1 = self.env['account.move'].search([('move_type','=','in_invoice'), ('state', '=', 'open'), ('date_due', '>', self.start_date), ('date_due', '<', self.end_date), ('discount_due_date', '=', False)])
            ...
            for bill in vendor_bills:
                ...
                val = {
                    ...
                    'invoice_id': bill.id,
                    'invoice_date': bill.date_invoice,
