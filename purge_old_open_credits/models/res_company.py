...
class ResConfigSettings(models.TransientModel):
    ...
    purge_old_payment_day_limit = fields.Integer(default=180, string="Open Payment Active Days",
        config_parameter='purge_old_open_credits.purge_old_payment_day_limit')
    purge_old_credit_day_limit = fields.Integer(default=120, string="Open credit Active Days",
        config_parameter='purge_old_open_credits.purge_old_credit_day_limit')
