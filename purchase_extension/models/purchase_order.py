...
class PurchaseOrderLine(models.Model):
    ...
    # qty_received = fields.Float("Received Qty", compute='_compute_qty_owed', inverse='_inverse_qty_received', compute_sudo=True, store=True, digits='Product Unit of Measure')
