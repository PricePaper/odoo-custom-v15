...
class StockMove(models.Model):
    ...
    def _run_fifo(self, move, quantity=None):
        ...
        move.sale_line_id.storage_contract_line_id.order_id.id not in [99088,99087,99086,99085,99084,99083,99082,99081,99080,99079,99077,99076,99074,99073,99072,99071,99070,99075,105208,105207,105206]:
