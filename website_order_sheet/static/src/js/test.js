...
publicWidget.registry.searchNBar = publicWidget.Widget.extend({
     ...
     */
    start: function () {
        // $(this.$target).removeClass('o_searchbar_form')
        // console.log($(this.$target))
        this.$input = this.$('.search-query');

        this.searchType = this.$input.data('searchType');
        this.order = this.$('.o_search_order_byn').val();
        ...
        const form = this.$('.o_search_order_byn').parents('form');
    ...
    _render: function (res) {
        ...
        if (res && this.limit) {
            ...
            let template = 'website_order_sheet.s_searchbar.autocomplete';
